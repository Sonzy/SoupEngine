...
#include <assert.h>
#include "Error Handling/SurfaceException.h"
...
public:
	...
	void PutPixel(unsigned int x, unsigned int y, class Color c) noexcept;
...
private:
	Surface(unsigned int width, unsigned int height, std::unique_ptr<Color[]> pBufferPtr) noexcept;
