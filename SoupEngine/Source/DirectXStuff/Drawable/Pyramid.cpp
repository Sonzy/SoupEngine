	...
	TestObject(gfx, rng, adist, ddist, odist, rdist)
{
	...
	{
		auto pvs = std::make_unique<VertexShader>(gfx, L"Source/Shaders/PerPixelColorBlendVS.cso");
		auto pvsbc = pvs->GetByteCode();
		AddStaticBind(std::move(pvs));

		AddStaticBind(std::make_unique<PixelShader>(gfx, L"Source/Shaders/PerPixelColourBlendPS.cso"));
